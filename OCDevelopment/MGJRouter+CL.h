...
static NSString *const kMGJPassword			= @"API://User/Password";
...
static NSString *const kMGJFeedback			= @"API://System/Feedback";
static NSString *const kMGJShare			= @"API://System/Share";
