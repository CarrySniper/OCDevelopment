...
- (instancetype)init
{
	...
	dispatch_once(&onceToken, ^{
		instance = [super init];
		instance.collapseTextNodes = YES;
		instance.stripEmptyNodes = YES;
		instance.trimWhiteSpace = YES;
		instance.alwaysUseArrays = NO;
		instance.preserveComments = NO;
		instance.wrapRootNode = NO;
	});
	return instance;
}
...
{
	return [[XMLDictionaryParser sharedInstance] dictionaryWithParser:parser];
}

+ (NSDictionary<NSString *, id> *)dictionaryWithXMLData:(NSData *)data
{
	return [[XMLDictionaryParser sharedInstance] dictionaryWithData:data];
}

+ (NSDictionary<NSString *, id> *)dictionaryWithXMLString:(NSString *)string
{
	return [[XMLDictionaryParser sharedInstance] dictionaryWithString:string];
}

+ (NSDictionary<NSString *, id> *)dictionaryWithXMLFile:(NSString *)path
{
	return [[XMLDictionaryParser sharedInstance] dictionaryWithFile:path];
}
