...
- (void)setupData {
	NSArray *controllers = @[
							 @[@"首页", @"HBDMainViewController"],
							 @[@"观点", @"HBDBaseViewController"],
							 @[@"行情", @"HBDBaseViewController"],
							 @[@"我的", @"HBDMineViewController"]];
	[controllers enumerateObjectsUsingBlock:^(NSArray *array, NSUInteger idx, BOOL * _Nonnull stop) {
		NSString *normalImageName = [NSString stringWithFormat:@"tab_nor_%zd", idx];
		NSString *selectedImageName = [NSString stringWithFormat:@"tab_pre_%zd", idx];
